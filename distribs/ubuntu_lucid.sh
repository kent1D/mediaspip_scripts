...
# ubuntu_lucid
# 
# Installation des dépendances pour Ubuntu lucid
#
...
ubuntu_lucid_dep_install()
{
	...
	apt-get -q -y --force-yes install build-essential curl subversion git-core checkinstall libcxxtools-dev scons libboost-dev zlib1g-dev unzip \
		apache2 mysql-server php5-dev php-pear php5-curl php5-mysql php5-sqlite php5-gd libapache2-mod-php5 libmagick9-dev \
